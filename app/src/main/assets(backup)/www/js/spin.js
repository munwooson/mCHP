...
function setStartSpinner() {
    ...
    var opts = {
        ...
        , color: '#008899'         // #rgb or #rrggbb or array of colors
...
/* 로딩바 숨기기 */
function setLoginStopSpinner() {
   //console.log("spinner 끝");
   if (_SPINNER != null) {
        _SPINNER.stop();
        _SPINNER = null;
        loginMaskOff();
...
function logginMaskOn() {
    //console.log("maskOn => Call");
    var maskHeight = $(document).height() + 1000;
    var maskWidth = $(window).width();



    $('#maskImg').attr('width',maskWidth);
...
function loginMaskOff() {
    //console.log("maskOff=> Call");
